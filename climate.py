...
l_4 = 'false'		# locked
rp_4 = "high"		# priority
ao_4 = "0.5"		# away_offset
wm_4 = 'false'		# window_mode_enabled
tr_4 = 'false'		# true_radiant_enabled
...
l_5 = 'false'		# locked
rp_5 = "high"		# priority
ao_5 = "0.5"		# away_offset
wm_5 = 'false'		# window_mode_enabled
tr_5 = 'false'		# true_radiant_enabled
...
def on_message(mqttc, obj, msg):
	...
	global ss_4, m_4, st_4, l_4
	global ss_5, m_5, st_5, l_5
	global rp_2, ao_2, wm_2, tr_2
	global rp_3, ao_3, wm_3, tr_3
	global rp_4, ao_4, wm_4, tr_4
	global rp_5, ao_5, wm_5, tr_5
...
def get_nodes():
	...
	try:
		...
		topic = haverland_nodes_topic + "/4"
		infot = mqttc.publish(topic, d3, qos=0, retain=True)
		topic = haverland_nodes_topic + "/5"
		infot = mqttc.publish(topic, d4, qos=0, retain=True)
	except KeyError:
...
mqttc.username_pw_set(username="mqttuser" , password="mqttpassword")
mqttc.connect("10.10.10.5", 1883, 60)
...
("HAVERLAND/devs/htr/4/mode_command",0),
("HAVERLAND/devs/htr/5/mode_command",0),
("HAVERLAND/devs/htr/4/temperature_command",0),
("HAVERLAND/devs/htr/5/temperature_command",0),
("HAVERLAND/devs/htr/4/lock_command",0),
("HAVERLAND/devs/htr/5/lock_command",0),
("HAVERLAND/devs/htr/4/true_radiant_command",0),
("HAVERLAND/devs/htr/5/true_radiant_command",0),
("HAVERLAND/devs/htr/4/window_mode_command",0),
("HAVERLAND/devs/htr/5/window_mode_command",0),
("HAVERLAND/devs/htr/4/away_offset_command",0),
("HAVERLAND/devs/htr/5/away_offset_command",0),
("HAVERLAND/devs/htr/4/radiator_priority_command",0),
("HAVERLAND/devs/htr/5/radiator_priority_command",0),
